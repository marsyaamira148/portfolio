...
class Smarty extends BaseConfig
{
     ...
     * Caching is typically disabled in 'development' environment regardless of this setting.
     * @var bool
     */
    ...
    public array $smarty_modifiers = [
        'strtotime'     => 'strtotime',
        'diffForHumans' => 'diffForHumans', // Assuming this is a global function or you'll define it
        'json_encode'   => 'json_encode',
        'url_title'     => 'url_title',     // CodeIgniter helper, ensure it's loaded or use a wrapper
        ...
        'form_multiselect' => 'form_multselect',
        'url_is' => 'url_is',
        'form_checkbox' => 'form_checkbox',
        'form_radio' => 'form_radio',
        'http_build_query' => 'http_build_query',
        'csrf_token' => 'csrf_token',
        'validation_list_errors' => 'validation_list_errors',
        'validation_show_error' => 'validation_show_error',
        'dd' => 'dd',
        'auth' => 'auth',
