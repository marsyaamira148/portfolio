<?php
/* Smarty version 5.5.1, created on 2025-10-22 04:27:04
  from 'file:/home/marsya/projects/web-portfolio/app/Views/admin/dashboard.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_68f85d18150917_33872893',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f7768d6b118333b791b922d4deccacccbe5a5ba1' => 
    array (
...
function content_68f85d18150917_33872893 (\Smarty\Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_163482461968f85d1812f291_36653030', 'content');
?>

<?php $_smarty_tpl->getInheritance()->endChild($_smarty_tpl, 'layout.tpl', $_smarty_current_dir);
}
/* {block 'content'} */
class Block_163482461968f85d1812f291_36653030 extends \Smarty\Runtime\Block
{
    ...
    <div class="white_shd full margin_bottom_30 text-center">
      <div class="full graph_head">
        <div class="heading1 margin_0">
          <h2><i class="fa fa-newspaper-o"></i> Blog Terbaru</h2>
        </div>
      </div>
...
$_smarty_tpl->tpl_vars['__smarty_foreach_blogLoop']->value['index']++;
?>
      <?php if (($_smarty_tpl->getValue('__smarty_foreach_blogLoop')['index'] ?? null) < 3) {?>
        <?php $_smarty_tpl->assign('thumb', (($_smarty_tpl->getValue('base_url')).("uploads/blogs/")).($_smarty_tpl->getValue('blog')['image']), false, NULL);?>
        <tr>
          <td>
...
"
          ...
          <td class="text-start">
            <strong><?php echo (($tmp = $_smarty_tpl->getValue('blog')['title'] ?? null)===null||$tmp==='' ? '(Tanpa Judul)' ?? null : $tmp);?>
</strong><br>
            <a href="<?php echo $_smarty_tpl->getValue('base_url');?>
blog/view/<?php echo $_smarty_tpl->getValue('blog')['slug'];?>
" class="btn btn-xs btn-primary mt-1">Baca</a>
          </td>
          <td>
            <?php if ((true && (true && null !== ($_smarty_tpl->getValue('blog')['created_at'] ?? null))) && $_smarty_tpl->getValue('blog')['created_at'] != '') {?>
              <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('date_format')($_smarty_tpl->getValue('blog')['created_at'],"%d %b %Y");?>
          ...
          <td class="text-start">
            <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('truncate')(preg_replace('!<[^>]*?>!', ' ', (string) $_smarty_tpl->getValue('blog')['description']),80,"...");?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
  <?php } else { ?>
    <tr>
      <td colspan="4" class="text-center">Belum ada postingan blog.</td>
    </tr>
  <?php }?>
</tbody>
