<?php
/* Smarty version 5.5.1, created on 2025-08-07 03:24:59
  from 'file:/home/marsya/projects/web-portfolio/app/Views/admin/dashboard_2.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_68941c8bd09871_00643576',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '06d46d0e10bdcb6baab27315666b547e22b59951' => 
    array (
      0 => '/home/marsya/projects/web-portfolio/app/Views/admin/dashboard_2.tpl',
      1 => 1754537096,
      2 => 'file',
    ),
  ),
...
function content_68941c8bd09871_00643576 (\Smarty\Template $_smarty_tpl) {
...
<html lang="en">
   <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/fevicon.png');?>
"" type="image/png" />
      <!-- bootstrap css -->
...
"" />
      <!-- color css -->
      <link rel="stylesheet" href="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/css/color_2.css');?>
"" />
      <!-- select bootstrap -->
      <link rel="stylesheet" href="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/css/bootstrap-select.css');?>
"" />
      <!-- scrollbar css -->
      <link rel="stylesheet" href="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/css/perfect-scrollbar.css');?>
"" />
      <!-- custom css -->
               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/logo/logo_icon.png');?>
"" alt="#" /></a>
                     </div>
                  </div>
...
">> <span>Default Dashboard</span></a>
                           ...
                           <li>
                              <a href="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('admin/dashboard/style2');?>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/logo/logo_black.png');?>
"" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/layout_img/user_img.jpg');?>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/layout_img/user_img.jpg');?>
"" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/layout_img/msg2.png');?>
"" class="img-responsive" alt="#" /></span>
                                       ...
                                       <li>
                                          <span><img src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/images/layout_img/msg3.png');?>
"" class="img-responsive" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Smith</span>
...
>
      <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('base_url')('pluto/js/chart_custom_style2.js');?>
""><?php echo '</script'; ?>
>
   </body>
</html><?php }
